    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="personal_area.php" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Search by Category</span>
            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                          ...
                          /*
                            ...
                            //SELECT TC.MovimentoID, TC.Data, TC.Importo, CM.NomeCategoria FROM TMovimentiContoCorrente TC JOIN TCategorieMovimenti CM ON TC.CategoriaMovimentoID = CM.CategoriaMovimentoID WHERE TC.ContoCorrenteID = ? ORDER BY TC.MovimentoID DESC LIMIT 5"
                            */
                            ...
                            WHERE TC.ContoCorrenteID = ? AND CM.CategoriaMovimentoID= ?
                            ORDER BY TC.Data DESC ");
                            $sqltable->bind_param("ii",$contoID, $category);
                            $sqltable->execute();
                        ...
                        $message="Error impossible to load the results.";
                      ...
                      ?>
                                    ...
                                    <button type="button" class="btn btn-primary" onclick="redirectToPage('export3.php')" value ="countsearch"
