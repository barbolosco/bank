              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter your OTP code to change your password</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="submit">Change Password</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Don't have the OTP code yet? <a href="https://ccgroup3.altervista.org/php/sendemail.php">Send another OTP code</a></p>
                    </div>
                  </form>
