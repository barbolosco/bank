    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="personal_area.php" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Movement Details</span>
            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                          ...
                          $movimentoid=isset($_GET['MovimentoID']) ? $_GET['MovimentoID'] : 'Error MovimentoID is missing';
                            ...
                            $sqltable = $conn->prepare("SELECT TC.DescrizioneEstesa, TC.Saldo, TC.Data, TC.Importo, CM.NomeCategoria FROM TMovimentiContoCorrente TC JOIN TCategorieMovimenti CM ON TC.CategoriaMovimentoID = CM.CategoriaMovimentoID WHERE TC.MovimentoID = ? ORDER BY TC.Data DESC LIMIT 1");
                            $sqltable->bind_param("i",$movimentoid);
                            $sqltable->execute();
                            ...
                            if($contoID==$testID["ContoCorrenteID"]){
