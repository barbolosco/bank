    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="personal_area.php" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Search by Number</span>
            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                          ...
                          $_SESSION["count"]=$count;
                            ...
                            $sqltable = $conn->prepare("SELECT TC.DescrizioneEstesa, TC.Saldo, TC.Data, TC.Importo, CM.NomeCategoria FROM TMovimentiContoCorrente TC JOIN TCategorieMovimenti CM ON TC.CategoriaMovimentoID = CM.CategoriaMovimentoID WHERE TC.ContoCorrenteID = ? ORDER BY TC.MovimentoID DESC LIMIT ?");
                            $sqltable->bind_param("ii",$contoID, $count);
                            $sqltable->execute();
                      ...
                      ?>
                                    ...
                                    <button type="button" class="btn btn-primary" onclick="redirectToPage('export1.php')" value ="countsearch"
