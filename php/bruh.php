      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
            ...
            <li class="notification-item">
              ...
              <div>
                <h4>Assistance</h4>
                <p>If you have problems, do not hesitate to contact us from the contacts section or visit the F.A.Q
                  page.</p>
                <p>Less than an hour ago</p>
              </div>
            </li>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile" style="">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="http://ccgroup3.altervista.org/php/logout.php">
                ...
                <form name="FormRicarica" action="" method="post">
                  <div class="col-12">
                    ...
                    <div class="input-group has-validation">
                      ...
                      <input type="text" name="yourPhoneNumber" class="form-control" id="yourPhoneNumber">
                  ...
                  <br>
                  <button type="submit" class="btn btn-primary" value="ricarica" onclick="Ricarica()">Recharge</button>
                </form>
              </li>
              ...
              <div class="card info-card revenue-card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center justify-content-center">
                    ...
                    <div class="ps-3">
                      <button class="btn btn-link" id="hideRevenueBtn" onclick="toggleRevenueVisibility()">
                        <i class="bi bi-eye"></i>
                      </button>
                    </div>
                  </div>
              ...
              <div class="card recent-sales overflow-auto">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" style="">
                    <li class="dropdown-header text-start" style="padding-bottom:0px;padding-left:20px">
                      <h6>Filter</h6>
                    </li>
                    ...
                    <li class="recharge-phone">
                      ...
                      <form style="margin:20px;margin-top:5px;" action="" name="FormCount" method="post">
                        ...
                        <button type="button" class="btn btn-primary" onclick="redirectToPage('search-movement1.php', count)" value ="countsearch"
                        ...
                        <form style="margin:20px;margin-top:5px;" action="" name="FormDate" method="post">
                        <button type="button" class="btn btn-primary" onclick="redirectToPage2('search-movement2.php', startdate, enddate)" value ="datesearch"
                        ...
                        <div class="input-icon">
                          ...
                          <form style="margin:20px;margin-top:5px;" action="" name="FormCategory" method="post">
                          <div class="input-icon">
                          
                          <button type="button" onclick="redirectToPage('search-movement3.php', category)" value ="categorysearch"
                            class="btn btn-primary" style="margin-bottom:5px;font-size:14px;margin-top:10px">
                            serch for category:
                          </button>
                          </div>
...
//controlla attributi name e id
    ...
    if (floatval($amount) > floatval($saldo)) {
      ...
      if ($stmt3) {
        ...
        echo "<script type='text/javascript'>alert('$message');</script>";
        echo '<script type="text/javascript">Pulisci();</script>';
